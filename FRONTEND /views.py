...
import base64
from .utils.threat_detector import compute_threat_score, send_threat_alert
...
GEMINI_API_KEY = "AIzaSyD8IfV1hP1D6S18dfw6MTFg_v5cC5QS9Bs"  # Replace with your actual Gemini API Key
...
def crawl_onion_site(url, keyword):
    ...
    try:
        ...
        if not structured_text.strip():
            print("⚠️ No structured text found, using raw content")
        ...
        score = compute_threat_score(structured_text)
        print("threat score:" , score)

        if score > 10:
            send_threat_alert(url, score)
